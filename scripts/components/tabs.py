...
def mod_card(
    ...
    href = f'href="{profile_url}" target="_blank" rel="noopener noreferrer"' if profile_url else ""
    
    # Link icon (external link)
    link_icon = '''<svg class="mod-link-icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M6 10L14 2m0 0h-5m5 0v5M8 4H3a1 1 0 00-1 1v8a1 1 0 001 1h8a1 1 0 001-1V9"/></svg>''' if profile_url else ""
